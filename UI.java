...
JTextField sw = new JTextField(7);
JTextArea srcProgram =new JTextArea(24,40);
JTextArea objProgram =new JTextArea(24,40);
JTextArea symTable =new JTextArea(16,24);
JTextArea memDump =new JTextArea(10,40);
...
//Creating the icon		
		...
		//ImageIcon img1 = new ImageIcon(UI.class.getResource("a.jpg"));
...
//Creating the menu bar	
		...
		runMenu.add(run);
		JMenuItem compile = new JMenuItem("Assemble");
		runMenu.add(compile);
		...
		public void actionPerformed(ActionEvent event)
		{
				...
				l.setText(" "+myEng.getL()+" ");
				sw.setText(" "+myEng.getSW()+" ");
				symTable.setText(ass.getSymTab().toString());
				memDump.setText(myEng.debug());
				//output.setText(" "+myEng.final_output+" ");
				}
				catch(Exception e)
				{
		...
		//JLabel outLabel = new JLabel("Final Output");
		//northPanel.add(outLabel);
		//northPanel.add(output);
		JButton refresh = new JButton("Refresh");
		JButton run1 = new JButton(" Run");
		JButton assemble1= new JButton("Assemble");
		
		northPanel.add(refresh);
		northPanel.add(run1);
		northPanel.add(assemble1);
		...
		assemble1.addActionListener(new ActionListener()
		{
